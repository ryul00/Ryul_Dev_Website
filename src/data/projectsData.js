export const projectsData = [
    ...
    },
    {
        ...
        detail: {
            ...
            schedule: [
                { category: '기획', task: '아이디어 회의 / 유사 서비스 분석 및 보완 / 아이디어 확정', date: '03.16 ~ 03.31' },
                { category: '디자인', task: '와이어프레임 설계 및 싱글 게임 디자인 진행', date: '04.01 ~ 04.20' },
                { category: '1차 개발', task: '싱글 게임 프로토타입 개발 / 서버 구축 및 DB 연결', date: '04.21 ~ 05.04' },
                { category: '1차 테스트', task: 'EC2 서버 배포 및 싱글 게임 테스트 진행', date: '05.05 ~ 05.11' },
                { category: '2차 개발', task: '멀티 플레이 디자인 및 소켓 기반 멀티플레이 로직 개발', date: '05.12 ~ 05.24' },
                { category: '3차 개발', task: '멀티 게임 구현 및 소켓 서버 코드 리팩토링', date: '05.26 ~ 06.08' },
                { category: '배포 및 제출', task: '서비스 도메인 구매 및 최종 배포, 시연 영상 제작 및 보고서 제출', date: '06.11 ~ 06.15' }
            ],
            apiSpecs: [
